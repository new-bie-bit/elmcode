...
public class OrdersController {
    ...
    public ResponseResult<Integer> createOrders(Orders orders) throws Exception {
        return ordersService.createOrders(orders);
    }

    @RequestMapping("/getOrdersById")
    @CircuitBreaker(name = "getOrdersById", fallbackMethod = "fallback")
    public ResponseResult<Orders> getOrdersById(Orders orders) throws Exception {
        return ordersService.getOrdersById(orders.getOrderId());
    }

    @RequestMapping("/listOrdersByUserId")
    @CircuitBreaker(name = "listOrdersByUserId", fallbackMethod = "fallback")
    public ResponseResult<List<Orders>> listOrdersByUserId(Orders orders) throws Exception {
